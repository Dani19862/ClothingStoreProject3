    ...
    static class Program
    {
        ...
        public static void DataSeeding()
        {
            using (var dbcontext = new ClothingStoreDB()) // add 8 users 10 Orders  10 customers  12 products 
            {
                ...
                var order1 = new Order { EmployeeID = user1.UserID, OrderDate = new DateTime(2021, 11, 15), SendeingOrderDate = new DateTime(2021, 11, 24), CustomerID = 31, Category = Order.ProductCategory.Men , TotalPrice = 125, Quantity = 5, ProductsQuantity = new Dictionary<int, int>() { { 4, 5 } } };
                var order2 = new Order { EmployeeID = user2.UserID, OrderDate = new DateTime(2021, 11, 17), SendeingOrderDate = new DateTime(2021, 11, 20), CustomerID = 32, Category = Order.ProductCategory.Men, TotalPrice = 175, Quantity = 4, ProductsQuantity = new Dictionary<int, int>() { { 3, 1 }, { 7, 1 }, { 1, 2 } } };
                var order3 = new Order { EmployeeID = user3.UserID, OrderDate = new DateTime(2021, 11, 13), SendeingOrderDate = new DateTime(2021, 11, 18), CustomerID = 33, Category = Order.ProductCategory.Women, TotalPrice = 80, Quantity = 1, ProductsQuantity = new Dictionary<int, int>() { { 2, 1 } } };
                var order4 = new Order { EmployeeID = user4.UserID, OrderDate = new DateTime(2021, 11, 19), SendeingOrderDate = new DateTime(2021, 11, 23), CustomerID = 34, Category = Order.ProductCategory.Children, TotalPrice = 100, Quantity = 3, ProductsQuantity = new Dictionary<int, int>() { { 4, 1 }, { 1, 2 } } };
                var order5 = new Order { EmployeeID = user4.UserID, OrderDate = new DateTime(2021, 11, 15), SendeingOrderDate = new DateTime(2021, 11, 20), CustomerID = 35, Category = Order.ProductCategory.Men, TotalPrice = 350, Quantity = 6, ProductsQuantity = new Dictionary<int, int>() { { 5, 3 } } };
                var order6 = new Order { EmployeeID = user5.UserID, OrderDate = new DateTime(2021, 11, 21), SendeingOrderDate = new DateTime(2021, 11, 26), CustomerID = 36, Category = Order.ProductCategory.Men, TotalPrice = 195, Quantity = 4, ProductsQuantity = new Dictionary<int, int>() { { 6, 2 }, { 2, 1 }, { 8, 1 } } };
                var order7 = new Order { EmployeeID = user6.UserID, OrderDate = new DateTime(2021, 12, 10), SendeingOrderDate = new DateTime(2021, 12, 15), CustomerID = 37, Category = Order.ProductCategory.Men, TotalPrice = 25, Quantity = 1, ProductsQuantity = new Dictionary<int, int>() { { 7, 1 } } };
                var order8 = new Order { EmployeeID = user7.UserID, OrderDate = new DateTime(2021, 12, 01), SendeingOrderDate = new DateTime(2021, 12, 05), CustomerID = 38, Category = Order.ProductCategory.Women, TotalPrice = 100, Quantity = 2, ProductsQuantity = new Dictionary<int, int>() { { 8, 2 } } };
                var order9 = new Order { EmployeeID = user8.UserID, OrderDate = new DateTime(2021, 12, 15), SendeingOrderDate = new DateTime(2021, 12, 18), CustomerID = 39, Category = Order.ProductCategory.Men, TotalPrice = 125, Quantity = 3, ProductsQuantity = new Dictionary<int, int>() { { 9, 2 }, { 10, 1 } } };
                var order10 = new Order { EmployeeID = user1.UserID, OrderDate = new DateTime(2021, 12, 13), SendeingOrderDate = new DateTime(2021, 12, 17), CustomerID = 40, Category = Order.ProductCategory.Children, TotalPrice = 135, Quantity = 5, ProductsQuantity = new Dictionary<int, int>() { { 10, 1 }, { 2, 1 }, { 6, 2 }, { 12, 1 } } };
